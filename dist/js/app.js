...
var githubApiKey = exports.githubApiKey = "d6ef265d9a074543fb5585e69e54f491877f819c";
...
var fetchProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName + '?access_token=' + _secrets.githubApiKey);
var fetchRepoPromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName + '/repos?access_token=' + _secrets.githubApiKey);
var inputValue = "";
...
function callMyName() {
  console.log(profileName);
  fetchProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName + '?access_token=' + _secrets.githubApiKey);
  fetchRepoPromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName + '/repos?access_token=' + _secrets.githubApiKey);
  console.log(fetchRepoPromise, fetchProfilePromise);

  _jquery2.default.when(fetchProfilePromise, fetchRepoPromise).then(function (profileData, repoData) {
