...
var fetchProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName);
var fetchRepoPromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName + '/repos');
var inputValue = "";
...
function callMyName() {
  console.log(profileName);
  fetchProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName);
  fetchRepoPromise = _jquery2.default.getJSON('https://api.github.com/users/' + profileName + '/repos');
